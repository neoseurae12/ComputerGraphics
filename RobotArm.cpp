...
float Teapot_ShoulderAng = 0;
float Teapot_ElbowAng = 0;
float Teapot_WristAng = 0;
float Teapot_WristTwistAng = 0;
bool toggleOdd = false;
...
int RightButtonDown = 0;	// hw4_my code
int RobotControl = 0;
...
void myDisplay()
{
	...
	objectXform = glm::rotate(objectXform, Teapot_BaseSpin * 0.03f, glm::vec3(0.0f, 1.0f, 0.0f));
	objectXform = glm::rotate(objectXform, BaseSpin * 0.03f, glm::vec3(0.0f, -1.0f, 0.0f));
	objectXform = glm::translate(objectXform, glm::vec3(TeapotX - BaseTransX - 0.5f, 0.0f, TeapotZ - BaseTransZ));

	// base
	model = glm::translate(model, glm::vec3(BaseTransX, 0.0f, BaseTransZ));
	model = glm::rotate(model, BaseSpin * 0.03f, glm::vec3(0.0f, 1.0f, 0.0f));
	DrawBase(model);

	// arm segment 1 (ShoulderAng)
	model = glm::translate(model, glm::vec3(0.0f, 0.4f, 0.0f));
	model = glm::rotate(model, ShoulderAng * 0.015f, glm::vec3(0.0f, 0.0f, 1.0f));
	DrawArmSegment(model);

	/**/
	// objectXform's shoulder
	objectXform = glm::translate(objectXform, glm::vec3(0.0f, 0.4f, 0.0f));
	objectXform = glm::rotate(objectXform, ShoulderAng * 0.015f, glm::vec3(0.0f, 0.0f, 1.0f));
	objectXform = glm::rotate(objectXform, Teapot_ShoulderAng * 0.015f, glm::vec3(0.0f, 0.0f, 1.0f));
	objectXform = glm::rotate(objectXform, ShoulderAng * 0.015f, glm::vec3(0.0f, 0.0f, -1.0f));
	objectXform = glm::translate(objectXform, glm::vec3(0.0f, -0.4f, 0.0f));

	// arm segment 2 (ElbowAng)
	model = glm::translate(model, glm::vec3(0.0f, 0.5f, 0.0f));
	model = glm::rotate(model, ElbowAng * 0.015f, glm::vec3(0.0f, 0.0f, 1.0f));
	DrawArmSegment(model);
	...
	//objectXform = glm::rotate(objectXform, ShoulderAng * 0.015f, glm::vec3(0.0f, 0.0f, 1.0f));
	objectXform = glm::rotate(objectXform, ElbowAng * 0.015f, glm::vec3(0.0f, 0.0f, 1.0f));
	//objectXform = glm::rotate(objectXform, Teapot_ShoulderAng * 0.015f, glm::vec3(0.0f, 0.0f, 1.0f));
	objectXform = glm::rotate(objectXform, Teapot_ElbowAng * 0.015f, glm::vec3(0.0f, 0.0f, 1.0f));
	objectXform = glm::rotate(objectXform, ElbowAng * 0.015f, glm::vec3(0.0f, 0.0f, -1.0f));
	//objectXform = glm::rotate(objectXform, ShoulderAng * 0.015f, glm::vec3(0.0f, 0.0f, -1.0f));
	objectXform = glm::translate(objectXform, glm::vec3(0.0f, -0.5f, 0.0f));
	objectXform = glm::translate(objectXform, glm::vec3(0.0f, -0.4f, 0.0f));
	...
	model = glm::rotate(model, WristTwistAng * 0.02f, glm::vec3(0.0f, 1.0f, 0.0f));
	DrawWrist(model);
	...
	objectXform = glm::translate(objectXform, glm::vec3(0.0f, 0.5f, 0.0f));
	objectXform = glm::rotate(objectXform, WristAng * 0.015f, glm::vec3(0.0f, 0.0f, 1.0f));
	objectXform = glm::rotate(objectXform, Teapot_WristAng * 0.015f, glm::vec3(0.0f, 0.0f, 1.0f));
	objectXform = glm::rotate(objectXform, WristAng * 0.015f, glm::vec3(0.0f, 0.0f, -1.0f));
	objectXform = glm::translate(objectXform, glm::vec3(0.0f, -0.5f, 0.0f));
	//objectXform = glm::rotate(objectXform, ElbowAng * 0.018f, glm::vec3(0.0f, 0.0f, -1.0f));
	//objectXform = glm::rotate(objectXform, ShoulderAng * 0.02f, glm::vec3(0.0f, 0.0f, -1.0f));
	...
	objectXform = glm::rotate(objectXform, WristTwistAng * 0.02f, glm::vec3(0.0f, 1.0f, 0.0f));
	objectXform = glm::rotate(objectXform, Teapot_WristTwistAng * 0.02f, glm::vec3(0.0f, 1.0f, 0.0f));
	objectXform = glm::rotate(objectXform, WristTwistAng * 0.02f, glm::vec3(0.0f, -1.0f, 0.0f));
	//objectXform = glm::rotate(objectXform, WristAng * 0.018f, glm::vec3(0.0f, 0.0f, -1.0f));
	objectXform = glm::translate(objectXform, glm::vec3(0.0f, -0.5f, 0.0f));
	//objectXform = glm::rotate(objectXform, ElbowAng * 0.018f, glm::vec3(0.0f, 0.0f, -1.0f));
	...
	glm::mat4 objectXform_static = objectXform;
	if (!toggleOdd) {
		DrawObject(objectXform_static);
	}
	
	glm::mat4 leftFinger = model;
	glm::mat4 rightFinger = model;

	// left finger base
	leftFinger = glm::translate(leftFinger, glm::vec3(0.0f, 0.2f, 0.0f));
	leftFinger = glm::rotate(leftFinger, FingerAng1 * 0.015f, glm::vec3(0.0f, 0.0f, 1.0f));
	DrawFingerBase(leftFinger);

	// right finger base
	rightFinger = glm::translate(rightFinger, glm::vec3(0.0f, 0.2f, 0.0f));
	rightFinger = glm::rotate(rightFinger, FingerAng1 * -0.015f, glm::vec3(0.0f, 0.0f, 1.0f));
	DrawFingerBase(rightFinger);

	// left finger tip
	leftFinger = glm::translate(leftFinger, glm::vec3(0.0f, 0.35f, 0.0f));
	leftFinger = glm::rotate(leftFinger, FingerAng2 * 0.015f, glm::vec3(0.0f, 0.0f, 1.0f));
	DrawFingerTip(leftFinger);

	// right finger tip
	rightFinger = glm::translate(rightFinger, glm::vec3(0.0f, 0.35f, 0.0f));
	rightFinger = glm::rotate(rightFinger, FingerAng2 * -0.015f, glm::vec3(0.0f, 0.0f, 1.0f));
...
void mouse_callback(GLFWwindow* window, double xpos, double ypos)
{
	...
	// hw4_my code
	float xoffset_view = (float)(xpos - lastX);
	float yoffset_view = (float)(lastY - ypos);
	...
	if (RightButtonDown)
	{
		...
		camera.ProcessMouseMovement(xoffset_view, yoffset_view);
	}
	...
	if (LeftButtonDown)
	{
		...
		case 3: 
			...
			break;
		case 4: 
			FingerAng1 += yoffset  * 90; FingerAng2 += xoffset * 180;
			break;
		}
	} 
